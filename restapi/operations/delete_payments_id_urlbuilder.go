...
func (o *DeletePaymentsIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeletePaymentsIDURL")
	}
...
func (o *DeletePaymentsIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeletePaymentsIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeletePaymentsIDURL")
	}
