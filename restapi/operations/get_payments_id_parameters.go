...
// GetPaymentsIDParams contains all the bound params for the get payments ID operation
...
func (o *GetPaymentsIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPaymentsIDParams) validateID(formats strfmt.Registry) error {
