...
// NewDeletePaymentsIDParams creates a new DeletePaymentsIDParams object
// no default values defined in spec.
func NewDeletePaymentsIDParams() DeletePaymentsIDParams {

	return DeletePaymentsIDParams{}
}

// DeletePaymentsIDParams contains all the bound params for the delete payments ID operation
...
func (o *DeletePaymentsIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeletePaymentsIDParams) validateID(formats strfmt.Registry) error {
